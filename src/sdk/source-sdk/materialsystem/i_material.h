...
using materialhandle_t = unsigned short; // handle to a material
...
public:
    ...
    {
        return memory::call_v_function<const char* (__thiscall*)(void*)>(this, 2)(this);
    }
    ...
    {
        return memory::call_v_function<void(__thiscall*)(void*, float)>(this, 27)(this, a);
    }

    void color_modulate(float r, float g, float b)
    {
        return memory::call_v_function<void(__thiscall*)(void*, float, float, float)>(this, 28)(this, r, g, b);
    }
